...
PROPERTIES = [
    {
        ...
        "property_type": "apartment", "purpose": "sale",
        "address": "12, 100 Feet Road, Indiranagar", "locality": "Indiranagar", "city_name": "Bengaluru",
        "price": 18500000, "bedrooms": 3, "bathrooms": 2, "balconies": 2, "parking_spots": 2,
        "built_up_area": 1840, "carpet_area": 1620, "furnishing": "fully_furnished",
        "floor_number": 8, "total_floors": 12,
        "has_gym": True, "has_security": True, "has_lift": True, "has_power_backup": True,
        "is_featured": True, "is_verified": True, "agent_index": 0,
    },
    {
        ...
        "address": "Plot 7, Road No. 10, Jubilee Hills", "locality": "Jubilee Hills", "city_name": "Hyderabad",
        "price": 42000000, "bedrooms": 5, "bathrooms": 4, "balconies": 3, "parking_spots": 3,
        "built_up_area": 3200, "furnishing": "fully_furnished",
        "has_gym": True, "has_pool": True, "has_security": True, "has_garden": True,
        "has_lift": True, "has_clubhouse": True, "has_power_backup": True,
        "is_featured": True, "is_verified": True, "agent_index": 2,
    },
    {
        ...
        "property_type": "penthouse", "purpose": "sale",
        "address": "The Grand, Carter Road, Bandra West", "locality": "Bandra West", "city_name": "Mumbai",
        "price": 75000000, "bedrooms": 4, "bathrooms": 3, "balconies": 2, "parking_spots": 2,
        "built_up_area": 2600, "furnishing": "fully_furnished", "floor_number": 32, "total_floors": 32,
        "has_gym": True, "has_pool": True, "has_security": True, "has_lift": True,
        "has_clubhouse": True, "has_power_backup": True, "pet_friendly": True,
        "is_featured": True, "is_verified": True, "agent_index": 1,
    },
    {
        ...
        "property_type": "apartment", "purpose": "sale",
        "address": "Prestige Gardens, 5th Block, Koramangala", "locality": "Koramangala", "city_name": "Bengaluru",
        "price": 9500000, "bedrooms": 2, "bathrooms": 2, "balconies": 1, "parking_spots": 1,
        "built_up_area": 1180, "carpet_area": 980, "furnishing": "semi_furnished",
        "floor_number": 3, "total_floors": 8,
        "has_gym": True, "has_security": True, "has_lift": True,
        "is_featured": False, "is_verified": True, "agent_index": 0,
    },
    {
        ...
        "property_type": "office", "purpose": "lease",
        "address": "DLF Cyber Hub, Tower B, Sector 24", "locality": "Cyber City", "city_name": "Gurugram",
        "price": 21000000, "built_up_area": 3500, "parking_spots": 5, "furnishing": "fully_furnished",
    ...
    },
    {
        ...
        "property_type": "plot", "purpose": "sale",
        "address": "Sunshine Enclave, Sarjapur Road", "locality": "Sarjapur Road", "city_name": "Bengaluru",
        "price": 12000000, "built_up_area": 2400, "plot_area": 2400,
        "is_featured": False, "is_verified": True, "facing": "east",
    },
    {
        ...
        "property_type": "villa", "purpose": "sale",
        "address": "Greenfields Township, Viman Nagar", "locality": "Viman Nagar", "city_name": "Pune",
        "price": 29000000, "bedrooms": 4, "bathrooms": 4, "balconies": 2, "parking_spots": 2,
        "built_up_area": 2800, "furnishing": "semi_furnished",
        "has_gym": True, "has_pool": True, "has_security": True, "has_garden": True,
        "has_clubhouse": True, "has_power_backup": True,
        "is_featured": True, "is_verified": True, "agent_index": 3,
    },
    {
        ...
        "address": "Oaktree Residences, Sector 2, HSR Layout", "locality": "HSR Layout", "city_name": "Bengaluru",
        "price": 25000, "bedrooms": 1, "bathrooms": 1, "built_up_area": 480,
        "furnishing": "fully_furnished", "floor_number": 2, "total_floors": 5,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for p in PROPERTIES:
            ...
            prop = Property.objects.create(city=city, agent=agent, **p)
        ...
        if not User.objects.filter(username='admin').exists():
            User.objects.create_superuser(
                username='admin',
                email='admin@housesquare.com',
                password='Admin@1234'
            )
            self.stdout.write('  ✅ Superuser created: aman / aman@1234')
        else:
